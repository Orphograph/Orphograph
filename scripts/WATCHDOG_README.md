...
- Per-probe JSONL: `~/.orphograph/logs/orphograph_watchdog.jsonl`
- launchd stdout/stderr: `~/Library/Logs/orphograph_watchdog.log`
- Alert overflow (when Telegram is unavailable): `~/.orphograph/logs/orphograph_watchdog_ALERT.txt`
...
tail -f ~/.orphograph/logs/orphograph_watchdog.jsonl
```
