...
ANCHOR_RATE_CAPACITY = int(os.environ.get("RATE_LIMIT_PER_HOUR", "10"))
ANCHOR_RATE_REFILL = ANCHOR_RATE_CAPACITY / 3600.0
...
def _build_sitemap() -> str:
    ...
    urls: list[tuple[str, str]] = [
        ...
        ("/lp/journalist-source-timestamp.html", "0.7"),
        ...
        if not pack_consumed and not subscription_active:
            ...
            if not allowed:
                ...
                body = json.dumps({
                    ...
                    "limit_per_hour": ANCHOR_RATE_CAPACITY,
