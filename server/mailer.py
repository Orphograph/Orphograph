...
def send_receipt_email(to: str, receipt: dict) -> bool:
    ...
    text = (
        ...
        f"complete; commitment to Bitcoin is anticipated within the next "
        f"block (approximately one hour).\n\n"
        f"  Receipt          {rid}\n"
        f"  SHA-256          {hash_hex}\n"
    ...
    html = (
        ...
        f"commitment to Bitcoin is anticipated within the next block "
        f"(approximately one hour).</p>"
        f"<table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" "
        f"style=\"margin:18px 0;border-collapse:collapse;font-size:14px;\">"
