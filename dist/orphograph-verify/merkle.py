...
# Source of truth: server/merkle.py
# Source sha256:   564dd480a4e793867c20c6fe22d265a3382674250023e8095b48b951db2d352d
# Vendored so the dist/orphograph-verify/ tree is fully standalone — a
# third-party verifier can drop this directory anywhere and run verify.py
# without the rest of the Orphograph repository. To refresh this copy:
#     cp server/merkle.py dist/orphograph-verify/merkle.py
#     shasum -a 256 server/merkle.py   # update the line above
# ---------------------------------------------------------------------------
