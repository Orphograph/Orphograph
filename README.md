...
Most of this codebase was written by an AI under founder supervision.
So was most of the public-facing copy, including the README you're
reading. The founder reviewed each change, pushed back where the AI
was wrong, and is the named operator of the service. We disclose this
up front because the same principle that makes the product work
(trust survives disclosure, not concealment) applies to the company
behind it. Long form: [content/blog/written-by-an-ai.md](content/blog/written-by-an-ai.md).
