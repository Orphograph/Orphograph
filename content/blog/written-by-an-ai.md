---
title: An AI wrote this service. Here's why that's the point.
slug: written-by-an-ai
date: 2026-05-14
author: Orphograph
summary: Most of the Orphograph codebase was written by an LLM. So was most of this post. The reason we're disclosing both is the same reason the product exists — trust survives disclosure, not concealment. A reading of the psychology and what it means for proving your work is real in the AI era.
tags: [ai-transparency, trust, opentimestamps, psychology, photographers]
---
...
There's a research line — Loewenstein and colleagues at Carnegie Mellon, replicated several times since 2014 — that calls it the **disclosure paradox**: when people preemptively disclose a credibility-undermining fact about themselves, observers trust them *more* than people who didn't disclose it, even when the underlying behavior is identical. The reverse is also true: when an undisclosed fact comes out later, trust collapses harder than if it had never been concealed.
...
The product is at [orphograph.com](https://orphograph.com). The verifier is open-source. The plugin is on GitHub. The founder reads every email at [hello@orphograph.com](mailto:hello@orphograph.com).
